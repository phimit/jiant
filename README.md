Note: this is a fork of the jiant (a framework for multi-task learning in NLP).
This fork is designed to address various discourse related tasks (mainly discourse segmentation and discourse markers identification).

For instructions to reproduce results for the disrpt 2023 campaign see [README_disrpt23.md](./README_disrpt23.md)
