...
for dataset in disrpt23_eng_dep_scidtb_conllu disrpt23_eng_pdtb_pdtb_conllu disrpt23_eng_rst_rstdt_conllu disrpt23_eng_sdrt_stac_conllu disrpt23_eus_rst_ert_conllu disrpt23_fas_rst_prstc_conllu disrpt23_fra_sdrt_annodis_conllu disrpt23_ita_pdtb_luna_conllu disrpt23_nld_rst_nldt_conllu disrpt23_por_rst_cstn_conllu disrpt23_rus_rst_rrt_conllu disrpt23_spa_rst_rststb_conllu disrpt23_spa_rst_sctb_conllu disrpt23_tur_pdtb_tdb_conllu disrpt23_zho_dep_scidtb_conllu disrpt23_zho_pdtb_cdtb_conllu disrpt23_zho_rst_gcdt_conllu disrpt23_zho_rst_sctb_conllu; 
do
 ...
 python simple_mtl_run.py "${dataset}" --model-name $MODEL --epochs 30 --eval-every-step 500 \
   --batch-size 1 --gradient-accumulation-steps 4 --no_improvements_for_n_evals 10 \
	 ...
	 --config-dir exp/tasks/configs/disrpt23 --freeze-layers 0-12
