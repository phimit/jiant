...
# testing on spanish
for dataset in "disrpt23_spa_rst_merged_split disrpt23_spa_rst_rststb_split,disrpt23_spa_rst_sctb_split" "disrpt23_zho_rst_merged_conllu disrpt23_zho_rst_gcdt_conllu,disrpt23_zho_rst_sctb_conllu" "disrpt23_zho_rst_merged_split disrpt23_zho_rst_gcdt_split,disrpt23_zho_rst_sctb_split";
do
...
set -- $dataset
 python simple_mtl_run.py "$1" --model-name $MODEL --epochs 30 --eval-every-step 500 \
	...
	--config-dir exp/tasks/configs/disrpt23 --freeze-layers 0-11 --ood $2        
done; 
